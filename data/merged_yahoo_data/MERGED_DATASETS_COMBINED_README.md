# Merged Yahoo News Datasets (Combined)

## Download

[Download Yahoo_news_data_combined.zip (Google Drive)](https://drive.google.com/file/d/18-ZK9hd_N46fXbf_c92HRbq9CcACelD4/view?usp=sharing)

---

## Overview
My CSV combined with Zachery's CSV based on his Data Schema getting rid of the Divends and Stock Splits columns. 

---

## Files

### 1. `merged_yahoo_news_combined.csv`
**Complete dataset with all trading days**
- **Rows:** 602,962
- **Contains:** All ticker-date combinations from Yahoo Finance
- **News coverage:** 38,008 rows have news (6.3%), 564,954 rows have no news (93.7%)

### 2. `merged_yahoo_news_combined__news_only.csv`
...
- **Tickers with news:** 369 (75.2% coverage)
...
**Row without news (only in `merged_yahoo_news_combined.csv`):**
```
Date: 2018-11-29
Open: 43.829761
High: 43.863354
